...
*/
 ...
 camshoter_devices: CAMSHOTURL varchar(100) NOT NULL DEFAULT ''
 camshoter_devices: RTSPURL varchar(100) NOT NULL DEFAULT ''
 camshoter_devices: PORT varchar(100) NOT NULL DEFAULT ''
